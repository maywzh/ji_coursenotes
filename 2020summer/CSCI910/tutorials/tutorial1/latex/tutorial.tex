...
Both user requirements and system requirements are needed in the Requirements specification. The reusable components can be used to correct the requirements modification. Lack of control of the reusable components make it necessary to make some repeat in the process.
\end{homeworkProblem}
\begin{homeworkProblem}
