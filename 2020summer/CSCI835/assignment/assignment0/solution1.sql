...
CREATE TABLE hotel(
hname	        VARCHAR(50)     NOT NULL, /* hotel name  */
country         VARCHAR(30)     NOT NULL, /* country it is located in		*/
city            VARCHAR(30)     NOT NULL, /* city		*/
street          VARCHAR(100)    NOT NULL, /* street name		*/
bnum            VARCHAR(10)     NOT NULL, /* building number	*/
star            INTEGER         NOT NULL, /* stars	*/
...
departure_date  DATE            NULL,  /* departure  date 	*/
    ...
    CONSTRAINT DATECHK CHECK (departure_date > arrival_date));
