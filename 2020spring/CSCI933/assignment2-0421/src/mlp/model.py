...
names = [
    'no_pregnant', 'pla_glu_concentration', 'blood_pressure(mmHg)',
    'skin_fold_thickness(mm)', 'serum_insulin(U/ml)', 'bmi',
    'diab_pedigree_fun', 'age', 'class'
]

dataset = pandas.read_csv('pima-indians-diabetes.data.csv',
                          delimiter=',',
                          names=names)
