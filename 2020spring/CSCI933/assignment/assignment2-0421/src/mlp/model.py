...
dataset = pandas.read_csv('pima-indians-diabetes.data.csv', delimiter=',', names=names)
...
# Fit the model
model.fit(X_train, Y_train, nb_epoch=10000, batch_size=40, callbacks=[tensorboard])
