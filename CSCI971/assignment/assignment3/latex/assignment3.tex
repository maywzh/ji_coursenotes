...
\begin{homeworkProblem}
   ...
   Answers:
   \begin{itemize}
     \item Q1.  Basic CBC mode encryption needs padding.
     \item Q2.  Our implementation uses rand. IV
     \item Q3.  CTR mode lets you build a stream cipher from a block cipher.
     \item Q4.  Always avoid the two time pad!
   \end{itemize}
\end{homeworkProblem}
\end{document}
