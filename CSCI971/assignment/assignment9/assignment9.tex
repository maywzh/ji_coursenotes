...
\begin{homeworkProblem}
    ...
    Alice knows the public key $pk$ and $F(k,m)=H(m)^k$, she choose a random $\rho\leftarrow Z_q $ and  sends Bob $\widehat{m}=H(m)\cdot g^\rho$. 
...
\clearpage
\begin{homeworkProblem}
    Alice and Bob there are anything
