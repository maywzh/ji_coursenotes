...
First, We need to find the output instance with the highest Probability. To generate the highest output differencial Probability.  We need to find the probable 

Then we should index the possibility. 
