...
% \begin{figure}[htbp!]
% 	\centering
% 	\includegraphics[width=0.9\textwidth]{ch2-fig4.png}
...
\begin{align}
	MHA(Q,K,V) = (h_1\|h_2\|\ldots\|h_t) \times W^{(Aggregate)}\label{fml:mhaout}
\end{align}
