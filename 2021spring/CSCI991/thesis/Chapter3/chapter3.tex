...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{ch2-fig1.jpeg}
	\caption{Overview Model Structure}
	\label{fig1}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{ch2-fig2.jpeg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{ch2-fig3.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{ch2-fig4.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{ch2-fig5.jpeg}
