...
\begin{figure}[h]
	\centering
	\includegraphics[height=1.0\textheight]{ch2-fig12-r.png}
...
\subsection{Dataset}
%本文中的实验数据来自于2010-2019年的高考数学考题以及模拟题（包含答案解析），共2236道。
...
% \begin{table}
% 	\centering
% 	\caption{Comparison of experimental results when the tag frequency threshold is 100 and 50 respectively}
% 	\label{Table:ch2-ex2}
% 	\begin{tabular}{ccccccccc}
% 		\hline \multirow{2}{*} {\text { 评价指标 }} & \multicolumn{5}{c} {\text { 间值: } 100} & \multicolumn{3}{c} {\text { 间值: } 50}                                                                                                       \\
% 		\cline { 2 - 9 }                            & \text { 本文方法 }                       & \text { BR }                            & \text { MLKNN } & \text { CC } & \text { 本文方法 } & \text { BR } & \text { MLKNN } & \text { CC } \\
% 		\hline \text { SubAcc } \uparrow            & 0.79                                     & 0.76                                    & 0.76            & 0.75         & 0.42               & 0.37         & 0.21            & 0.41         \\
% 		\text { HmLoss } \downarrow                 & 0.12                                     & 0.13                                    & 0.16            & 0.16         & 0.07               & 0.07         & 0.09            & 0.07         \\
% 		\text { Precision } \uparrow                & 0.82                                     & 0.79                                    & 0.76            & 0.77         & 0.65               & 0.55         & 0.53            & 0.62         \\
% 		\text { Recall } \uparrow                   & 0.82                                     & 0.78                                    & 0.76            & 0.76         & 0.56               & 0.50         & 0.38            & 0.59         \\
% 		\text { F1score } \uparrow                  & 0.82                                     & 0.78                                    & 0.76            & 0.76         & 0.58               & 0.51         & 0.41            & 0.58         \\
% 		\text { F1 macro } \uparrow                 & 0.83                                     & 0.82                                    & 0.78            & 0.77         & 0.51               & 0.52         & 0.42            & 0.51         \\
% 		\text { F1 micro } \uparrow                 & 0.82                                     & 0.81                                    & 0.76            & 0.77         & 0.56               & 0.55         & 0.47            & 0.58         \\
% 		\text { Coverage } \downarrow               & 1.39                                     & 1.47                                    & 1.48            & 1.50         & 9.67               & 10.28        & 13.10           & 9.01         \\
% 		\text { AP\uparrow }                        & 0.88                                     & 0.85                                    & 0.84            & 0.84         & 0.59               & 0.52         & 0.42            & 0.60         \\
% 		\hline
% 	\end{tabular}
% \end{table}
