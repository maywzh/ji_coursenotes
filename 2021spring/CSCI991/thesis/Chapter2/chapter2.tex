...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\textwidth]{ch2-gcn-ov.pdf}
...
\begin{itemize}
	...
	\item Multi-label KNN (ML-KNN): Proposed by Zhang et al.\cite{zhang2007ml}, it searchs the k instances closest to the instance through the KNN algorithm, count the number of each category in the k samples, use the Naive Bayes algorithm to generate prediction outcomes for each label.
...
There are many adjustable parameters of the model such as
