...
\begin{figure}[htbp!]
	\centering
	\includegraphics[width=0.8\textwidth]{ch2-rnn-model.pdf}
...
\begin{figure}[htbp!]
	\centering
	\includegraphics[width=0.8\textwidth]{ch2-lstm-model.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{ch2-bilstm-model.pdf}
