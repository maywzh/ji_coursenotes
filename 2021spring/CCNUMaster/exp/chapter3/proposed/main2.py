...
import argparse
from model import MODEL, MODEL_BH, MODEL_GBH
...
def main():
    ...
    if dataset == 'assist2009_updated':
        parser.add_argument('--q_embed_dim', type=int,
                            default=50, help='question embedding dimensions')
        ...
        parser.add_argument('--memory_size', type=int,
                            default=20, help='memory size')
        parser.add_argument('--n_question', type=int, default=124,
        ...
        parser.add_argument(
            '--load', type=str, default='assist2009_updated', help='model file to load')
        parser.add_argument(
            '--save', type=str, default='assist2009_updated', help='path to save model')

    elif dataset == 'STATICS':
        parser.add_argument('--batch_size', type=int,
                            default=10, help='the batch size')
        parser.add_argument('--q_embed_dim', type=int,
                            default=50, help='question embedding dimensions')
        parser.add_argument('--qa_embed_dim', type=int, default=100,
                            help='answer and question embedding dimensions')
        parser.add_argument('--memory_size', type=int,
                            default=50, help='memory size')
        parser.add_argument('--n_question', type=int, default=1223,
                            help='the number of unique questions in the dataset')
        parser.add_argument('--seqlen', type=int, default=6,
                            help='the allowed maximum length of a sequence')
        ...
        parser.add_argument('--load', type=str,
                            default='STATICS', help='model file to load')
        parser.add_argument('--save', type=str,
                            default='STATICS', help='path to save model')
    ...
    all_data = None
    train_q_data, train_qa_data, train_bh1_data, train_bh2_data, train_bh3_data, train_bh4_data, valid_q_data, valid_qa_data, valid_bh1_data, valid_bh2_data, valid_bh3_data, valid_bh4_data = None, None, None, None, None, None, None, None, None, None, None, None
    model = None
    # first fold
    if params.use_additional_feature:
        ...
        train_q_data, train_qa_data, train_bh1_data, train_bh2_data, train_bh3_data, train_bh4_data, valid_q_data, valid_qa_data, valid_bh1_data, valid_bh2_data, valid_bh3_data, valid_bh4_data = all_data[
            0]
        model = MODEL_GBH(n_question=params.n_question,
