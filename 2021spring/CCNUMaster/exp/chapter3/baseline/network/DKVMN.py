...
class DKVMN(nn.Module):
    ...
    def __init__(self, key_dim, value_dim, summary_dim, question_num, concept_num):
        ...
        self._key_memory = torch.Tensor(
            self._key_dim, self._concept_num).to(ARGS.device)
    ...
    def _init_value_memory(self):
        ...
        self._value_memory = torch.Tensor(
    ...
    def _write(self, interaction):
        ...
        e = self._sigmoid(self._erase_layer(
            interaction_vector))  # erase vector
