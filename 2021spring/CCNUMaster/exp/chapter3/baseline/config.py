...
dataset_list = ['2009', '2012', '2015', 'ASSISTmentsChall',
...
base_args.add_argument('--base_path', type=str, default='./data')
base_args.add_argument('--weight_path', type=str)
base_args.add_argument('--dataset_name', type=str,
                       default='ASSISTments2009', choices=dataset_list)
