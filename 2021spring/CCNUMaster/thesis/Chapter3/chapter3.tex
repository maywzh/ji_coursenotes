...
Due to the nature of GKVMN, the knowledge mastery \(M^{(v)}\) is explicit, so it can be directly used as a kind of recommendation system for judgment. And it can be subsequently used as a student knowledge mastery state analysis.
...
\begin{itemize}
    \item ASSISTment 2009-2010~\cite{assistmentdata2009} is a data set used to predict student test performance. It consists of a series of exercises containing several knowledge point labels and some student answer records. It was collected on an online education platform in 2015. After data filtering, a data set containing 19,917 students, about 102 thousand exercises, 100 knowledge point labels, and about 709 interactions was obtained.
