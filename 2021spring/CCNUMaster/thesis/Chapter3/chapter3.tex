...
This mechanism introduces students' personalized answering characteristics, thus enabling computation with personalized weights for the exercises' knowledge points. It makes full use of neural networks' feature representing the ability to extract the hidden factors that affect the correctness of students' answers, thus improving the overall reliability of the model.
