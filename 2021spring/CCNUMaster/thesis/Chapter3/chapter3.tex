...
%在学生进行习题练习的过程中，一个习题与多个知识点相关，根据认知诊断理论，学生对于知识点的掌握程度与学生的内在学习能力决定了学生答题的正确性。
