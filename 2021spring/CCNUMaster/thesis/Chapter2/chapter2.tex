...
\begin{figure}[htbp!]
    ...
    \caption{The architecture of the proposed knowledge labeling model. The left part is the text representation module, consisting of the Bi-LSTM layer and attention layer, generating one exercise text vector. The right part is the GCN-based knowledge label classifier generator, producing classifiers for knowledge labeling. The outputted labels are the product of the classifier vectors and the text representing vector.}\label{fig:ch2-modelarchitecture}
\end{figure}
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=0.8\textwidth]{ch2-preprocessing.pdf}
    \caption{The procedure of preprocessing. The text is first segmented into a list of words, in which the irrelevant words are then cleaned. The words are finally re-merged into one sentence.}\label{fig:ch2-model-preprocessing}
\end{figure}
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=0.75\textwidth]{ch2-bert-wwm.pdf}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.65\textwidth]{ch2-bert-model.pdf}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.55\textwidth]{ch2-att-model.pdf}
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=0.9\textwidth]{ch2-gcn-model.pdf}
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=1.0\linewidth]{ch2-gcncls-model.pdf}
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=1.0\textwidth]{ch2-knowledgenet.pdf}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=1.0\textwidth]{ch2-data-heatmap.png}
