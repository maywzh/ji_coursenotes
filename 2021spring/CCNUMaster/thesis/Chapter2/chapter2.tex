...
\begin{itemize}
    ...
    \item BERT+RCNN\@: Use BERT as the text sequence encoder and
\end{itemize}
...
As can be seen from the \tblname{\ref{tbl:ch2-result-detail}}, the performance of the models proposed in this paper is stronger for exercises that occur more frequently than those that occur less frequently. As the frequency of knowledge points decreases and the difficulty of classification increases, the model shows a degradation of performance. This is because the model is prone to overfitting when the sample size of the exercises is small, which can lead to the degradation of the model prediction performance. The problem can be solved by increasing the sample size and optimizing the data quality.
