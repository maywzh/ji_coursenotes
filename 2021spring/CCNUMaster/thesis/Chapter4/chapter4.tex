...
Five different \(\tau \) (0.45, 0.5, 0.55) are applied as the threshold for judging the predicting correctness of the exercises. The result is shown in \tblname{\ref{tbl:ch4-exp-result}}. %~\ref{tbl:ch4-exp-result}.
\begin{table}[htbp!]
