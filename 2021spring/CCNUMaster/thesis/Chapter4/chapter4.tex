...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.9\textwidth]{ch4-fig-architecture.png}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.9\textwidth]{ch4-model-matching.pdf}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.9\textwidth]{ch4-ranking-model.png}
