...
\begin{abstract}{Graph neural network}{Knowledge point labeling}{Knowledge tracing}{Exercise recommendation}{}
    ...
    In the knowledge tracing module, an improved model for the DKVMN knowledge tracing network is proposed, integrating the node information propagation mechanism of graph neural networks as the network's memory units and students' answering behaviors as an extra feature. The experiments showed that the proposed model outperforms baseline models and original DKVMN models in specific metrics.
