...
\begin{frame}
	...
	\begin{description}
		...
		\item[Exercise recommendation] Recommend appropriate exercises according to their knowledge status
	\end{description}
\end{frame}
...
\begin{frame}
	...
	Design a recommendation system dedicated to high school Math exercise with the following features:
	\begin{itemize}
		\item Knowledge labelling for exercises
		\item Knowledge mastery proficiency tracking
		\item Exercise recommendation
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Exercise recommendation}
		A mathematical exercise recommendation model of Matching-Ranking stages~\cite{segev2009context} based on knowledge mastery evaluation.
	\end{block}
\end{frame}
%------------------------------------------------
...
\begin{frame}
	\frametitle{Future}
	\begin{itemize}
		\item Normalization method applying in the co-existence statistics
		\item Multi-head attention mechanism in graph propagation 
		\item Adaptive matching strategies
	\end{itemize}
\end{frame}
%------------------------------------------------
