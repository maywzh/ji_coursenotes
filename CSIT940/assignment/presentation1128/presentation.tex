...
M. Hausknecht et al. [9] employed evolutionary neural networks to extract higher-dimensional representation forms from the raw game screen.
\end{frame}

\subsection{Reinforcement Learning}
\begin{frame}
\frametitle{RL-based GVGP}
It is a best-first search algorithm that incrementally builds a tree representation of the search space of a problem (e.g., a game) and estimates the values of states by performing simulations.
\end{frame}
